...
- **CSV Export** with time frame selection (1m, 3m, 6m, 12m, or by year).
- **Split Transactions** support with grouped display in transaction history.
- **Siri Integration** for quick transaction entry via natural language.
